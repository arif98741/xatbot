...
class Bot extends Eloquent
{
     ...
     */
    protected $fillable = [
        'bot_status_id', 'creator_user_id', 'server_id', 'premium',
    ...
    {
        return $this->belongsToMany(Command::class, 'bot_command_minrank', 'bot_id', 'command_id')
    ...
    {
        return $this->belongsToMany(Minrank::class, 'bot_command_minrank', 'bot_id', 'minrank_id')
